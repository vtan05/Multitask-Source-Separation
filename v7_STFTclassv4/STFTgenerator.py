...
from utils import wavtospec, checkNoise

class Generator(Sequence):
    def __init__(self, batch_size, shuffle, mode, dim=(257, 626), n_channels=1, n_classes=4):
        self.mode = mode
        if self.mode is "train":
            self.data_dir = "D:/Data/Musdb18/16000/train/"
            self.csv_file = pd.read_csv("D:/Data/Musdb18/16000/train.csv")
        elif self.mode is "test":
            self.data_dir = "D:/Data/Musdb18/16000/test/"
            self.csv_file = pd.read_csv("D:/Data/Musdb18/16000/test.csv")
        elif self.mode is "valid":
            self.data_dir = "D:/Data/Musdb18/16000/valid/"
            self.csv_file = pd.read_csv("D:/Data/Musdb18/16000/valid.csv")
    ...
    def __data_generation(self, name, num):
        ...
        return (X, {"sep_sources": y, "sourceclass": sourceclass, "recov_input": X})
