...
def main(args):
    ...
    # Predict
    audio, sr = librosa.load("samples/piano.wav", offset=70, duration=3, mono=True, sr=16000)
    ...
    write_wav("vocal_piano.wav", voc_istft, sr, norm=False)
    ...
    write_wav("dru_piano.wav", dru_istft, sr, norm=False)
    ...
    write_wav("others_piano.wav", others_istft, sr, norm=False)
